        ...
        try:
            ...
            if signup_data:
                if signup_data.username == username and signup_data.password == password:
                    ...
                    return JsonResponse({'status': 'success', 'message': 'login successful', 'login_status': True, 'token': token, 'data': {'user_type': signup_data.user_type, 'username': signup_data.username, 'full_name': signup_data.full_name, 'email': signup_data.email, 'user_id': signup_data.id}})
                else:
